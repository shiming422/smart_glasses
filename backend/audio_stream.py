...
def _flush_stream_client(sc: StreamClient):
    """Drop stale queued audio while keeping the playback stream connected."""
    try:
        while True:
            sc.q.get_nowait()
...
async def hard_reset_audio(reason: str = "", close_streams: bool = False):
    """
