  ...
  connectVisionWS() {
    ...
    this.ws.onmessage = (event) => {
      ...
      if (event.data instanceof Blob) {
        ...
        const img = new Image();
        img.onload = () => {
          this.lastFrameW = img.naturalWidth || img.width || this.lastFrameW;
          this.lastFrameH = img.naturalHeight || img.height || this.lastFrameH;
          this.drawContain(img, this.lastFrameW, this.lastFrameH);
